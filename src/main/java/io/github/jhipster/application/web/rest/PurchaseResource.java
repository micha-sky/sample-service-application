...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Purchase}.
 */
@RestController
@RequestMapping("/api")
public class PurchaseResource {
    ...
    public List<PurchaseDTO> getAllPurchases(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
